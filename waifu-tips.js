...
function loadWidget(waifuPath, apiPath) {
	...
	function registerEventListener() {
		...
		$("#waifu-tool .fa-camera-retro").click(() => {
			showMessage("照好了嘛，是不是很可爱呢？子瑜小姐姐也这么觉得", 6000, 9);
		...
		$("#waifu-tool .fa-times").click(() => {
			...
			showMessage("愿你有一天能与重要的人重逢。我和主人等你哦！", 2000, 11);
		...
		console.log(re);
		re.toString = () => {
			showMessage("哈哈，你打开了控制台，是想要看看我的小秘密吗？我都没告诉子瑜小姐姐", 6000, 9);
			return "";
		};
		$(document).on("copy", () => {
			showMessage("你都复制了些什么呀，转载要记得加上出处哦！子瑜小姐姐写得很辛苦呢！", 6000, 9);
		});
	...
	var userAction = false,
		hitokotoTimer = null,
		messageTimer = null,
		messageArray = ["子瑜小姐姐是我的主人哦！", "不要丧了，你也许是别人藏在心里的光！", "好累但是也要加油哦！", "为子瑜小姐姐打Call!"];
	...
	function loadRandModel() {
		...
		$.ajax({
			...
			success: function(result) {
				...
				else showMessage("我的新衣服好看嘛？不要告诉主人，她也想要", 4000, 10);
